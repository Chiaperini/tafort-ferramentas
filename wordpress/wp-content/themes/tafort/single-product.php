    ...
    <div class="produto">
        ...
        <div class="exposicao">
            ...
            <div class="imagens">
                ...
                <img loading="lazy" class="img-principal" src="<?= $imagemDestaque ?>" alt="<?= bloginfo() . '-' . the_title(); ?>"">
                ...
                <div class="galeria">
                    ...
                    ?>
                        <img loading="lazy" class="img" src="<?= $original_image_url ?>" onclick="changeMainImage('<?= $original_image_url ?>')" alt="<?= bloginfo() . '-' . the_title(); ?>">
                    <?php endforeach; ?>
    ...
    <div class="postPage">
        ...
        <div class="container">
            ...
            <div class="singlePost">
                ...
                <img loading="lazy" src="<?= $imagemDestaque ?>" alt="<?= bloginfo() . '-' . the_title(); ?>">
